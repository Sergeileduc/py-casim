...
def test_cli_size_opt(runner):
    ...
    resp = runner.invoke(cli.main, ['--size', '125', 'tests/test_casim/sample image.png'])  # noqa: E501
...
def test_cli_all_opt(runner, mini_bbcode):
    ...
    resp = runner.invoke(cli.main, ['--all', 'tests/test_casim/sample image.png'])  # noqa: E501
    assert resp.exit_code == 0
...
def test_cli_ode_opt(runner, mini_bbcode):
    ...
    resp = runner.invoke(cli.main, ['--code', 4, 'tests/test_casim/sample image.png'])  # noqa: E501
    assert resp.exit_code == 0
