...
To install Python Casim, run this command in your terminal:
...
The sources for Python Casim can be downloaded from the `Github repo`_.
...
.. code-block:: console
    ...
    $ curl -OJL https://github.com/sergeileduc/py_casim/tarball/master
